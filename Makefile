...
#    Updated: 2025/08/20 10:55:15 by renato           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
BONUS = ./bonus/bonus_src/main.o ./bonus/bonus_src/game/game.o ./bonus/bonus_src/game/inputs.o ./bonus/bonus_src/game/inputs_utils.o ./src/parser/map_utils.o ./src/parser/split_content.o ./src/parser/handle_error.o ./src/parser/map_data.o ./src/parser/get_map_matrix.o ./src/parser/get_map_matrix_utils.o ./src/utils.o ./src/utils2.o ./src/parser/map_val_validate_map_size.o ./src/parser/validate_map.o ./src/parser/map_val_flood_fill.o ./src/parser/map_val_outside_flood_fill.o ./src/parser/map_val_check_isolated_spaces.o ./src/parser/map_val_validate_textures.o ./src/parser/map_val_validate_player.o ./src/parser/map_val_validate_map_position.o ./src/parser/map_val_validate_edges.o ./src/parser/map_val_validate_colors.o ./src/parser/map_val_check_valid_lines.o ./src/parser/map_val_check_valid_map_elements.o ./src/parser/map_val_check_missing_identifier.o ./src/parser/map_val_check_map.o ./src/parser/map_val_check_double_identifier.o ./bonus/bonus_src/utils.o ./bonus/bonus_src/utils2.o ./bonus/bonus_src/graphics/graphics_render.o ./bonus/bonus_src/graphics/graphics_render2.o ./bonus/bonus_src/graphics/graphics_player_info.o ./bonus/bonus_src/graphics/graphics_mlx.o ./bonus/bonus_src/graphics/graphics_utils.o ./bonus/bonus_src/graphics/graphics_minimap.o ./utils/ft_atoi.o ./utils/ft_memcpy.o ./utils/ft_memset.o ./utils/ft_split.o ./utils/ft_strcmp.o ./utils/ft_strdup.o ./utils/ft_strjoin.o ./utils/ft_strlen.o ./utils/ft_strnstr.o ./utils/get_next_line.o ./utils/ft_isdigit.o ./utils/ft_calloc.o ./utils/ft_substr.o ./utils/ft_strchr.o ./utils/ft_memmove.o ./utils/ft_memcmp.o ./utils/ft_strstr.o ./utils/ft_strncmp.o
SRC_BONUS = ./bonus/bonus_src/main.c ./bonus/bonus_src/game/game.c ./bonus/bonus_src/game/inputs.c ./bonus/bonus_src/game/inputs_utils.c ./src/parser/map_utils.c ./src/parser/split_content.c ./src/parser/handle_error.c ./src/parser/map_data.c ./src/parser/get_map_matrix.c ./src/parser/get_map_matrix_utils.c ./src/utils.c ./src/utils2.c ./src/parser/map_val_validate_map_size.c ./src/parser/validate_map.c ./src/parser/map_val_flood_fill.c ./src/parser/map_val_outside_flood_fill.c ./src/parser/map_val_check_isolated_spaces.c ./src/parser/map_val_validate_textures.c ./src/parser/map_val_validate_player.c ./src/parser/map_val_validate_map_position.c ./src/parser/map_val_validate_edges.c ./src/parser/map_val_validate_colors.c ./src/parser/map_val_check_valid_lines.c ./src/parser/map_val_check_valid_map_elements.c ./src/parser/map_val_check_missing_identifier.c ./src/parser/map_val_check_map.c ./src/parser/map_val_check_double_identifier.c ./bonus/bonus_src/graphics/graphics_render.c ./bonus/bonus_src/graphics/graphics_render2.c ./bonus/bonus_src/graphics/graphics_player_info.c ./bonus/bonus_src/graphics/graphics_mlx.c ./bonus/bonus_src/graphics/graphics_utils.c ./bonus/bonus_src/graphics/graphics_minimap.c ./utils/ft_atoi.c ./utils/ft_memcpy.c ./utils/ft_memset.c ./utils/ft_split.c ./utils/ft_strcmp.c ./utils/ft_strdup.c ./utils/ft_strjoin.c ./utils/ft_strlen.c ./utils/ft_strnstr.c ./utils/get_next_line.c ./utils/ft_isdigit.c ./utils/ft_calloc.c ./utils/ft_substr.c ./utils/ft_strchr.c ./utils/ft_memmove.c ./utils/ft_memcmp.c ./utils/ft_strstr.c ./utils/ft_strncmp.c
